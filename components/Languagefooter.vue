        ...
        >
          ...
          >
            ...
            >
              <DialogTitle
                as="h3"
                class="text-lg font-medium leading-6 dark:text-black text-white"
              >
          ...
          >
            <nuxt-link
              ...
              class="flex py-1 hover:bg-colorBgDark dark:hover:bg-colorBgLight hover:text-black dark:hover:text-white dark:text-black text-white px-4 rounded inline-block w-full"
              @click="closeModal"
            >
              <img
